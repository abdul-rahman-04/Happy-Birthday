...
/* ===== HERO TYPING EFFECT ===== */
const heroText = "Today isn’t just another day on the calendar — it's the day the world was blessed with someone truly amazing and that's you. ( Attitude mattum raani level 👑… behavior la innum innocent piece thaan 😂 ). Small small moments join together to make this life beautiful…… And you make those moments unforgettable. Click around, explore pannitu enjoy pannunga.. Because today is all about YOU 🤍.";
